...
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct GvrInfoList {
    pub entries: Vec<GvrInfoListInfo>,
}

#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct GvrInfoListInfo {
...
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct GvrInfoOrder {
    pub entries: Vec<GvrInfoOrderInfo>,
}
...
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct GvrTermUebEdit {
    pub order_id: Option<String>,
    pub order_id_old: Option<String>,
}

#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct GvrTermUebList {
    pub entries: Vec<GvrTermUebListEntry>,
}

#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct GvrTermUebListEntry {
    pub my: Konto,
    pub other: Konto,
    pub value: Option<Value>,
    pub key: Option<String>,
