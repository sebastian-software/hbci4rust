...
| Release hardening | This page; `docs/architecture/release-checklist.md`; `docs/reference/packaging.md`; `docs/reference/passport-storage-security.md`; `docs/reference/unsupported-surfaces.md`; `docs/reference/upstream-header-review.md`; `docs/reference/parser-generator-goldens.md`; `docs/rustification/README.md`; porting plan; ADRs 0246, 0249, 0251, 0252, 0253, and 0254 | Remaining work is visible, package metadata/package-list review, storage security review, public unsupported-surface reference, upstream header recheck, and parser/generator golden policy are recorded, and v1 is not declared complete | Complete final release-candidate gates and any remaining explicit limitation docs. |
