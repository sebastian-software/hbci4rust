...
| --- | --- | --- | --- |
| Scope and baseline | ADRs 0001, 0003, 0005, and 0258; `scripts/fetch-upstream.sh` | Accepted and pinned to hbci4java `hbci4j-core-4.1.11` / `3b7ce667c73724daa1c836ed7333ed090c21a831`; future baseline or scope changes require a new ADR before dependent work counts as evidence | Keep scope stable unless a new ADR changes v1. |
