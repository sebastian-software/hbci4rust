...
| Release hardening | This page; `docs/architecture/release-checklist.md`; `docs/reference/packaging.md`; `docs/reference/passport-storage-security.md`; `docs/reference/unsupported-surfaces.md`; `docs/rustification/README.md`; porting plan; ADRs 0246, 0249, 0251, and 0252 | Remaining work is visible, package metadata/package-list review, storage security review, and public unsupported-surface reference are recorded, and v1 is not declared complete | Complete final release-candidate gates, upstream header recheck, and any remaining explicit limitation docs. |
