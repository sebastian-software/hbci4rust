...
| Release hardening | This page; `docs/architecture/release-checklist.md`; `docs/reference/packaging.md`; `docs/rustification/README.md`; porting plan; ADRs 0246 and 0249 | Remaining work is visible, package metadata/package-list review is recorded, and v1 is not declared complete | Complete final release-candidate gates, upstream header recheck, and any explicit limitation docs. |
