...
- [ ] `Cargo.toml` package metadata is reviewed for crate publication.
- [ ] `cargo package --list` is reviewed before publishing.
- [ ] Generated or copied upstream artifacts are documented with attribution.
